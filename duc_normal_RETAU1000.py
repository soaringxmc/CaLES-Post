...
plt.plot(dns.centerline.y, dns.centerline.uu/utau**2, color='black', label='DNS')
for i in range(len(folders)):
  les = Duct(folders[i])
  les.read_stats()
  plt.plot(les.centerline.z, les.centerline.uu/utau**2, label=f'$\Delta_z/h={les.dy:.3f}$')

plt.gca().set_prop_cycle(None)
plt.plot(dns.centerline.y, dns.centerline.vv/utau**2, color='black')
for i in range(len(folders)):
  les = Duct(folders[i])
  les.read_stats()
  plt.plot(les.centerline.z, les.centerline.ww/utau**2)

plt.gca().set_prop_cycle(None)
plt.plot(dns.centerline.y, dns.centerline.ww/utau**2, color='black')
for i in range(len(folders)):
  les = Duct(folders[i])
  les.read_stats()
  plt.plot(les.centerline.z, les.centerline.vv/utau**2)
