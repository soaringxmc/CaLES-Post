...
plt.plot(dz, err[:,0]*100, marker='o', markersize=4, label='$C_f$')
plt.plot(dz, err[:,1]*100, marker='s', markersize=4, label='$U$')
plt.plot(dz, err[:,2]*100, marker='^', markersize=4, label='$<uu>$')
plt.plot(dz, err[:,3]*100, marker='D', markersize=4, label='$<vv>$')
plt.plot(dz, err[:,4]*100, marker='P', markersize=4, label='$<ww>$')
plt.plot(dz, err[:,5]*100, marker='X', markersize=4, label='$<uw>$')
plt.xscale('log')
plt.legend()
plt.xlabel('$\Delta z/h$')
plt.ylabel('Error (\%)')
# plt.show()
plt.savefig(f"convergence_DSMAG_AR1.pdf", format='pdf', bbox_inches='tight')
plt.close()