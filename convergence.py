...
plt.plot(dy, err[:,0]*100, marker='o', markersize=4, markerfacecolor='none', label=r'$C_f$')
plt.plot(dy, err[:,1]*100, marker='s', markersize=4, markerfacecolor='none', label=r'$U$')
plt.plot(dy, err[:,2]*100, marker='^', markersize=4, markerfacecolor='none', label=r'$\langle uu \rangle$')
plt.plot(dy, err[:,4]*100, marker='P', markersize=4, markerfacecolor='none', label=r'$\langle vv \rangle$')
plt.plot(dy, err[:,3]*100, marker='D', markersize=4, markerfacecolor='none', label=r'$\langle ww \rangle$')
plt.plot(dy, err[:,5]*100, marker='X', markersize=4, markerfacecolor='none', label=r'$\langle uv \rangle$')
plt.xscale('log')
plt.legend()
plt.xlabel('$\Delta z/h$')
plt.ylabel('Error (\%)')
plt.ylim([-10, 60])
# plt.show()
plt.savefig(f"convergence_DSMAG_AR2.pdf", format='pdf', bbox_inches='tight')
plt.close()